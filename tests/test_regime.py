...
class TestEfficiencyRatio:
    def test_pure_trend_gives_er_1(self):
        # Each bar moves +1; sum of |delta| = 5; |close - close[5]| = 5. ER = 1.0.
        clf = RegimeClassifier(RegimeConfig(er_len=5, cross_len=5, cross_threshold=2))
    ...
    def test_choppy_movement_low_er(self):
        # 100 -> 105 -> 100 -> 105 -> 100 -> 105. Total |delta| = 5*5=25. Net = |105-100|=5. ER = 5/25 = 0.2.
        clf = RegimeClassifier(RegimeConfig(er_len=5, cross_len=5, cross_threshold=2))
...
class TestHysteresis:
    ...
    def test_stays_directional_between_exit_and_enter(self):
        ...
        # Total |delta| = 1+1+1+1 = 4. Net = |102 - 104| = 2. ER = 0.5 - still above enter.
        ...
        #   bars 4..8: closes=[104,103,104,104,103], delta=[1,1,0,1], total=3, net=|103-104|=1, ER=0.33.
    ...
    def test_exits_when_er_below_er_exit(self):
        ...
        # 104 -> 100 -> 104 -> 100 -> 104: huge delta, zero net.
